...
const ModificationClient = () => {
    ...
    return (
        <div className="container p-4 m-3">
                <form className='form px-5 border-opacity-25 rounded bg-light m-5' onSubmit={onSubmit}>
                    <h1 className='title-form font-weight-bold text-center text-dark mt-5 py-5'>Modifier Client</h1>
                    <div className="mb-3">
